package com.linkser.foodapp.fragments.bottomsheet
...
import com.linkser.foodapp.databinding.FragmentMealBottomSheetBinding
...
class MealBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        observaBottomSheetMeal()
    }

    private fun observaBottomSheetMeal() {
